...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @GyrangeYT."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @GyrangeYT ."
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 183:
                ...
                try:
                    ...
                    full_command = f"./adarsh {target} {port} {time} 100"
...
Buy From :- @GyrangeYT
Official Channel :- https://t.me/Gyrange100
'''
...
3. MAKE SURE YOU JOINED https://t.me/Gyrange100 OTHERWISE NOT WORK
